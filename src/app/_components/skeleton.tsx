export function PostSkeleton() {
  return (
    <div className="animate-pulse rounded-lg bg-white/10 p-5 backdrop-blur-sm">
      <div className="mb-3 flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            {/* Name skeleton */}
            <div className="mb-1.5 h-5 w-32 rounded bg-white/20" />
            {/* Date skeleton */}
  ...
  return (
    <div className="mb-8 grid grid-cols-2 gap-4 md:grid-cols-4">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="rounded-lg bg-white/10 p-4 backdrop-blur-sm animate-pulse">
          <div className="mb-2 h-9 w-16 rounded bg-white/20" />
...
export function AdminPostSkeleton() {
  return (
    <div className="animate-pulse rounded-lg bg-white/10 p-6 backdrop-blur-sm">
      <div className="mb-4 flex items-start justify-between">
        <div className="flex-1">
          <div className="mb-2 flex items-center gap-3">
            ...
            <div>
              {/* Name skeleton */}
              <div className="mb-2 h-5 w-40 rounded bg-white/20" />
              {/* Date skeleton */}
        ...
        <div className="ml-4 h-7 w-24 rounded bg-white/20" />
      </div>

      {/* Action buttons skeleton */}
      <div className="flex gap-2">
        <div className="h-9 w-20 rounded bg-white/20" />
        <div className="h-9 w-20 rounded bg-white/20" />
